        ...
        <Template>
            ...
            <div className="lg:flex justify-center container mx-auto lg:pt-28">
                <div className="h-full lg:w-full lg:mt-12 w-[350px] lg:rounded-xl lg:bg-gray-100 lg:shadow-2xl">
                    <div className="">
                        <div className="ml-2 lg:hidden absolute">
                            <Link to="/home">
                        ...
                        <div className="mt-8 w-full">
                            <p className="text-xl text-center font-bold text-gray-500">User List</p>
                        </div>
                    </div>

                    <div className="mt-10 flex justify-center items-center">
                        <div className="grid lg:grid-cols-4 grid-cols-1 gap-3 ml-5 w-full mb-10">
                            { dataUser.map((post, i) => (
                                <div className="p-2 flex bg-white outline outline-1 outline-gray-200 rounded-xl shadow-2xl">
                                    <div className="rounded-full w-16 h-16 bg-gray-300 flex justify-center items-center">
                                    ...
                                    <div className='ml-5'>
                                        <div className="flex justify-left items-center">
                                            <p className='text-lg font-bold text-gray-500'>{post.first_name} {post.last_name}</p>
                                        </div>
                                        <div className='flex justify-left  items-center'>
                                            <p className='text-xs text-gray-300'>{post.email}</p>
                                        </div>
                                    </div>
                                </div>
                            ))}
            ...
            <div className="absolute bottom-20 right-5 lg:hidden">
                <Link to="/tambah">
                    <button className="rounded-full w-14 h-14 bg-blue-500 text-white text-5xl flex justify-center items-center">
